...
@Component({
  selector: 'app-add-accident-causes',
  templateUrl: './add-accident-causes.component.html',
  styleUrls: ['./add-accident-causes.component.scss']
})
export class AddAccidentCausesComponent {
  ...
  submitData() {
    if (this.accidentCausesForm.valid) {
      this.addDataService.AddAccidentCauses(this.accidentCausesForm.value).subscribe({
        next: data => {
