...
@Component({
  selector: 'app-add-prevention-categories',
  templateUrl: './add-prevention-categories.component.html',
  styleUrls: ['./add-prevention-categories.component.scss']
})
export class AddPreventionCategoriesComponent {
  ...
  submitData() {
    if (this.PreventionCategoryForm.valid) {
      this.addDataService.AddPreventionCategory(this.PreventionCategoryForm.value).subscribe({
        next: data => {
