...
@Component({
  selector: 'app-add-qhsenames',
  templateUrl: './add-qhsenames.component.html',
  styleUrls: ['./add-qhsenames.component.scss']
})
export class AddQHSENamesComponent {
  ...
  submitData() {
    if (this.QHSEPositionNameForm.valid) {
      this.addDataService.AddQHSEPositionName(this.QHSEPositionNameForm.value).subscribe({
        next: data => {
