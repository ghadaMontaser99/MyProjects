...
@Component({
  selector: 'app-add-qhsepositions',
  templateUrl: './add-qhsepositions.component.html',
  styleUrls: ['./add-qhsepositions.component.scss']
})
export class AddQHSEPositionsComponent {
  ...
  submitData() {
    if (this.QHSEPositionForm.valid) {
      this.addDataService.AddQHSEPosition(this.QHSEPositionForm.value).subscribe({
        next: data => {
