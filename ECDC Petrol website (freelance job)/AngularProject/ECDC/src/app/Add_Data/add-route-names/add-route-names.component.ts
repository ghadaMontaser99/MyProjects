...
@Component({
  selector: 'app-add-route-names',
  templateUrl: './add-route-names.component.html',
  styleUrls: ['./add-route-names.component.scss']
})
export class AddRouteNamesComponent {
  ...
  submitData() {
    if (this.RouteNameForm.valid) {
      this.addDataService.AddRouteName(this.RouteNameForm.value).subscribe({
        next: data => {
