...
@Component({
  selector: 'app-add-tool-pusher-positions',
  templateUrl: './add-tool-pusher-positions.component.html',
  styleUrls: ['./add-tool-pusher-positions.component.scss']
})
export class AddToolPusherPositionsComponent {
  ...
  submitData() {
    if (this.ToolPusherPositionForm.valid) {
      this.addDataService.AddToolPusherPosition(this.ToolPusherPositionForm.value).subscribe({
        next: data => {
