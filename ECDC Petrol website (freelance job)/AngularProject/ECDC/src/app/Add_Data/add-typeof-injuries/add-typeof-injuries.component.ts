...
@Component({
  selector: 'app-add-typeof-injuries',
  templateUrl: './add-typeof-injuries.component.html',
  styleUrls: ['./add-typeof-injuries.component.scss']
})
export class AddTypeofInjuriesComponent {
  ...
  submitData() {
    if (this.TypeOfInjuryForm.valid) {
      this.addDataService.AddTypeOfInjury(this.TypeOfInjuryForm.value).subscribe({
        next: data => {
