...
@Component({
  selector: 'app-add-violation-categories',
  templateUrl: './add-violation-categories.component.html',
  styleUrls: ['./add-violation-categories.component.scss']
})
export class AddViolationCategoriesComponent {
  ...
  submitData() {
    if (this.ViolationCategoryForm.valid) {
      this.addDataService.AddViolationCategory(this.ViolationCategoryForm.value).subscribe({
        next: data => {
