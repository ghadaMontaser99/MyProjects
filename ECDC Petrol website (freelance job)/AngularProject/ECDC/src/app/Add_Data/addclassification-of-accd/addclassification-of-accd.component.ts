...
@Component({
  selector: 'app-addclassification-of-accd',
  templateUrl: './addclassification-of-accd.component.html',
  styleUrls: ['./addclassification-of-accd.component.scss']
})
export class AddclassificationOfAccdComponent {
  ...
  submitData() {
    if (this.ClassificationOfAccidentForm.valid) {
      this.addDataService.AddClassificationOfAccident(this.ClassificationOfAccidentForm.value).subscribe({
        next: data => {
