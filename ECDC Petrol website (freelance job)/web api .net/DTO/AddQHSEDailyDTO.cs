...
namespace TempProject.DTO
{
    public class AddQHSEDailyDTO
	{
		...
		//public List<LeadershipVisitDTO> LeaderShipVisitsDTO { get; set; } 
		//public List<CrewDTO> CrewSaftyAlertDTO { get; set; }
		//public List<CrewDTO> CrewQuizDTO { get; set; }
		public List<int> LeaderShipVisitsDTO { get; set; } = new List<int> { };
		public List<int> CrewSaftyAlertDTO { get; set; } = new List<int> { };
		public List<int> CrewQuizDTO { get; set; } = new List<int> { };
